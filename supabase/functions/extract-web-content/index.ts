...
serve(async (req) => {
  ...
  try {
    ...
    try {
      ...
      await supabase
        ...
        .update({
          ...
          processing_error: `Failed to extract web content: ${extractErrorMessage}`,
        })
        .eq("id", note_id);
    ...
    try {
      ...
      const triggerErrorMessage = triggerError instanceof Error ? triggerError.message : "Failed to complete summarization process";
      ...
      await supabase
        ...
        .update({
          processing_status: "failed",
          processing_error: triggerErrorMessage,
        })
        .eq("id", note_id);
