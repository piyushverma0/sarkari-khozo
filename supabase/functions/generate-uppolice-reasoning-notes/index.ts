...
serve(async (req) => {
  ...
  try {
    ...
    console.log('🚀 Generating UP Police Reasoning RAW content for:', note_id, 'Topic:', topic || 'General')
...
Generate comprehensive study material for UP Police Mental Aptitude & Reasoning exam.

**Cover these key topics:**
1. Logical Reasoning (Analogies, Series, Coding-Decoding) (Ancient, Medieval, Modern, Freedom Struggle)
...
7. Uttar Pradesh State Reasoning (History, Geography, Culture, Administration, UP Police)
...
Return detailed markdown-formatted study material (NOT JSON). This raw content will be processed into structured notes.`
    ...
    const userPrompt = `Generate comprehensive UP Police Constable 2026 Mental Aptitude & Reasoning study material.

${topicContext}

Include:
- All major Reasoning topics relevant to UP Police exam
- Current affairs from last 6 months
- UP State Reasoning (10-15% weightage)
...
Create detailed, exam-focused markdown content.`
    ...
    console.log('📝 Triggering summarization for UP Police Reasoning notes...')
