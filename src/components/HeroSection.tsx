    ...
    <section className="pt-32 pb-16 px-4">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <div className="relative max-w-3xl mx-auto">
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-primary via-secondary to-accent opacity-50"></div>
          <div className="relative glass-card rounded-2xl p-8 shadow-[var(--shadow-card)] bg-card/40 m-[2px]">
