    ...
    <section className="pt-32 pb-16 px-4">
      <div className="container mx-auto max-w-4xl text-center">
        <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
          Track <span className="font-playfair italic">Exams</span>, <span className="font-playfair italic">Jobs</span> & <span className="font-playfair italic">Government Schemes</span> — All in One Place
        </h1>
