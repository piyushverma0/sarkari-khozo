...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class SupabaseLibraryAccessors extends SubDependencyFactory {
        private final SupabaseFunctionsLibraryAccessors laccForSupabaseFunctionsLibraryAccessors = new SupabaseFunctionsLibraryAccessors(owner);
        private final SupabaseGotrueLibraryAccessors laccForSupabaseGotrueLibraryAccessors = new SupabaseGotrueLibraryAccessors(owner);
        ...
        private final SupabaseStorageLibraryAccessors laccForSupabaseStorageLibraryAccessors = new SupabaseStorageLibraryAccessors(owner);

        public SupabaseLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>supabase.functions</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SupabaseFunctionsLibraryAccessors getFunctions() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSupabaseFunctionsLibraryAccessors;
        }

        /**
         * Group of libraries at <b>supabase.gotrue</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SupabaseGotrueLibraryAccessors getGotrue() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSupabaseGotrueLibraryAccessors;
        }
        ...
        /**
         * Group of libraries at <b>supabase.storage</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SupabaseStorageLibraryAccessors getStorage() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSupabaseStorageLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class SupabaseFunctionsLibraryAccessors extends SubDependencyFactory {

        public SupabaseFunctionsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>kt</b> with <b>io.github.jan-tennert.supabase:functions-kt</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getKt() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("supabase.functions.kt");
        }
     ...
     */
    @Deprecated
    public static class SupabaseGotrueLibraryAccessors extends SubDependencyFactory {

        public SupabaseGotrueLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getKt() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("supabase.gotrue.kt");
        }
     ...
     */
    @Deprecated
    public static class SupabaseStorageLibraryAccessors extends SubDependencyFactory {

        public SupabaseStorageLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>kt</b> with <b>io.github.jan-tennert.supabase:storage-kt</b> coordinates and
         * with version reference <b>supabase</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getKt() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("supabase.storage.kt");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>composeAnimation</b> with value <b>1.7.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>liveData</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>supabase</b> with value <b>2.0.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
